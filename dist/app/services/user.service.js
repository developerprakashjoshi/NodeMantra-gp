...
const user_schema_1 = require("@graphschema/user.schema");
let UsersResolver = class UsersResolver {
    ...
    createUser(input) {
        return __awaiter(this, void 0, void 0, function* () {
            const user = Object.assign({ id: this.users.length + 1 }, input);
    ...
    updateUser(id, input) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const updatedUser = Object.assign(Object.assign({}, user), input);
...
__decorate([
    ...
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Number, user_schema_1.UserInput]),
    __metadata("design:returntype", Promise)
