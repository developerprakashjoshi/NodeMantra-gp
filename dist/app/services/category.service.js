...
const category_schema_1 = __importDefault(require("@models/category.schema"));
...
class CategoryService extends service_1.default {
    constructor() {
        ...
        this.categoryModel = category_schema_1.default;
        // this.userModel = User;
        // this.postModel = Post;
    }
    count() {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const result = yield this.categoryModel.countDocuments();
                if (!result) {
    ...
    list() {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const result = yield this.categoryModel.find();
                if (!result) {
                    return new response_1.default(true, 200, 'Record not available', result);
                }
    ...
    retrieve(pid) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const record = yield this.categoryModel.findById(pid);
                if (!record) {
    ...
    retrieveByCategory(name) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const records = yield this.categoryModel.findOne({ name: name });
                return records;
            }
            catch (error) {
                return error;
    ...
    create(data) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                category.createdAt = (0, moment_1.default)().toDate();
                category.updatedAt = (0, moment_1.default)().toDate();
                yield this.searchEngine.addDocuments('category', category);
    ...
    update(pid, data) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const category = yield this.categoryModel.findById(pid);
                if (!category) {
                    return new response_1.default(true, 200, 'Record not available', category);
                }
                if (data.name) {
                    category.name = data.name;
                }
                ...
                yield this.searchEngine.updateIndex('category', category);
                const result = yield category.save();
    ...
    delete(pid) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                category.deletedAt = (0, moment_1.default)().toDate();
                yield this.searchEngine.deleteDocument('category', pid);
                const result = yield category.save();
    ...
    searchCategorys(query) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const result = yield this.searchEngine.search('category', query, searchOptions);
